...
- This package finally contains the `CHANGELOG.md` it has been listing in `files` since 1.12.0, and the link to it in this README no longer points outside the tarball.
