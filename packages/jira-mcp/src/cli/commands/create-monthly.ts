...
import { loadConfig } from '@softspark/atlassian-mcp-core';
import { InstancePool } from '../../connector/instance-pool.js';
import { GLOBAL_TASK_TEMPLATES_DIR } from '../../paths.js';
import { info, warn, error } from '@softspark/atlassian-mcp-core';
